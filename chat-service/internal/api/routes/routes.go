...
import (
	...
	"gorm.io/gorm"
	// Import docs - this will be generated by swag
	// If docs are not available, the build will fail, which is expected
	// Run 'swag init' to generate docs before building
	// _ "chat-service/docs"
)
