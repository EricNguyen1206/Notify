...
import (
	...
	"fmt"
	"time"
	"voting-service/internal/ports/dao"
...
func (s *VotingService) CreateTopic(ctx context.Context, req dao.CreateTopicRequest) (*models.Topic, error) {
...
func (s *VotingService) CastVote(ctx context.Context, voterID uint, topicID, optionID string) error {
	vote := &models.Vote{
		TopicID:  uuid.MustParse(topicID),
		OptionID: uuid.MustParse(optionID),
		UserID:   voterID,
	}
